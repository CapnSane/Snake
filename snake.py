...
class App:
    ...
    def __init__(self):
        ...
        self.game = Game()
        self.player = Player(1) # Initial size of the SNAKE
    ...
    def on_loop(self):
        ...
        for i in range(2,self.player.length):
            if self.game.isCollision(self.player.x[0],self.player.y[0],self.player.x[i], self.player.y[i],40):
                ...
                #         self.stim = 'You are terrible!'
                    
                #     def compare(self,other):

                #         if i in Player(x) < 10:
                #             return self.other == self.s1
                #         else:
                #             return self.other == self.s2
                
                # s1 = stimulus('bad')
                # s2 = stimulus('good')
                # s3 = stimulus('result')
                
                # s1.stim = 'You are terrible!'
                # s2.stim = 'You are great!'
